...
export const QISCUS_SDK_APP_ID = config.QISCUS_SDK_APP_ID;
export const QISCUS_SDK_SECRET = config.QISCUS_SDK_SECRET;
export const QISCUS_DEFAULT_ROOMS_ID = config.QISCUS_DEFAULT_ROOMS_ID;
export const QISCUS_MODERATOR_EMAIL = config.QISCUS_MODERATOR_EMAIL;
