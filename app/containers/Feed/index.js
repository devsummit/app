...
import Share, { ShareSheet,ButtonShare } from 'react-native-share';
                    ...
                    <View>
                      ...
                      <TouchableOpacity onPress={this.fetchNextFeeds}>
                        <Card>
                          ...
                          <CardItem>
                            <Left>
                              <Button transparent textStyle={{ color: '#87838B' }} onPress={() => this.openShareSheet(item.message, item.attachment )}>
                                <Icon name="share" />
                                <Text>Share</Text>
                              </Button>
                            </Left>
